...
\item 
void \mbox{\hyperlink{classCutflow_a42bd2909f9e32bb12e7dbd717248a253}{write}} (std\+::string output\+\_\+dir=\char`\"{}\char`\"{})
\item 
...
\item 
void \mbox{\hyperlink{classCutflow_a1657305fa62637aff34e1cece3d49d73}{set\+Debug\+Lambda}} (std\+::function$<$ void(\mbox{\hyperlink{classCut}{Cut}} $\ast$)$>$ new\+\_\+debugger)
...
\item 
void \mbox{\hyperlink{classCutflow_a4f7285409e90c76524ab0148e6fa0aa9}{recursive\+Write}} (\mbox{\hyperlink{classCut}{Cut}} $\ast$cut, std\+::ofstream \&ofstream, std\+::string output\+\_\+cflow)
\item 
void \mbox{\hyperlink{classCutflow_a398daefa870d9f58381047324a880701}{recursive\+Write\+CSV}} (std\+::string output\+\_\+dir, \mbox{\hyperlink{classCut}{Cut}} $\ast$cut, Direction direction, int csv\+\_\+idx, Utilities\+::\+CSVFiles csv\+\_\+files)
\item 
void \mbox{\hyperlink{classCutflow_a212a44164cbf1f1608d1b55567890ef7}{recursive\+Write\+Mermaid}} (\mbox{\hyperlink{classCut}{Cut}} $\ast$cut, std\+::ofstream \&ofstream, std\+::string output\+\_\+mmd)
\item 
bool \mbox{\hyperlink{classCutflow_a3756a365662151832c84fe86031f10d6}{recursive\+Evaluate}} (\mbox{\hyperlink{classCut}{Cut}} $\ast$cut)
\item 
...
\item 
std\+::function$<$ void(\mbox{\hyperlink{classCut}{Cut}} $\ast$)$>$ \mbox{\hyperlink{classCutflow_abb96db5e150faecc23c88456f27a2764}{debugger}}
\item 
bool \mbox{\hyperlink{classCutflow_ae8792b03dddaac635316012514ed33a3}{debugger\+\_\+is\+\_\+set}}
\end{DoxyCompactItemize}
...
none 
\end{DoxyReturn}
\mbox{\Hypertarget{classCutflow_a3756a365662151832c84fe86031f10d6}\label{classCutflow_a3756a365662151832c84fe86031f10d6}} 
...
{\footnotesize\ttfamily bool Cutflow\+::recursive\+Evaluate (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classCut}{Cut}} $\ast$}]{cut }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}
...
\end{DoxyReturn}
\mbox{\Hypertarget{classCutflow_a4f7285409e90c76524ab0148e6fa0aa9}\label{classCutflow_a4f7285409e90c76524ab0148e6fa0aa9}} 
\index{Cutflow@{Cutflow}!recursiveWrite@{recursiveWrite}}
\index{recursiveWrite@{recursiveWrite}!Cutflow@{Cutflow}}
\doxysubsubsection{\texorpdfstring{recursiveWrite()}{recursiveWrite()}}
{\footnotesize\ttfamily void Cutflow\+::recursive\+Write (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classCut}{Cut}} $\ast$}]{cut,  }\item[{std\+::ofstream \&}]{ofstream,  }\item[{std\+::string}]{output\+\_\+cflow }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}

(PROTECTED) Recursively write RAPIDO cutflow file 
\begin{DoxyParams}{Parameters}
{\em cut} & pointer to current cut \\
\hline
{\em ofstream} & std\+::ofsteam object for RAPIDO .cflow file \\
\hline
{\em output\+\_\+flow} & name of .cflow file \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
none 
\end{DoxyReturn}
\mbox{\Hypertarget{classCutflow_a398daefa870d9f58381047324a880701}\label{classCutflow_a398daefa870d9f58381047324a880701}} 
\index{Cutflow@{Cutflow}!recursiveWriteCSV@{recursiveWriteCSV}}
\index{recursiveWriteCSV@{recursiveWriteCSV}!Cutflow@{Cutflow}}
\doxysubsubsection{\texorpdfstring{recursiveWriteCSV()}{recursiveWriteCSV()}}
{\footnotesize\ttfamily void Cutflow\+::recursive\+Write\+CSV (\begin{DoxyParamCaption}\item[{std\+::string}]{output\+\_\+dir,  }\item[{\mbox{\hyperlink{classCut}{Cut}} $\ast$}]{cut,  }\item[{Direction}]{direction,  }\item[{int}]{csv\+\_\+idx,  }\item[{Utilities\+::\+CSVFiles}]{csv\+\_\+files }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}

(PROTECTED) Recursively write cutflow level to CSV file(s) 
\begin{DoxyParams}{Parameters}
{\em output\+\_\+dir} & target directory for output CSV files \\
\hline
{\em cut} & pointer to current cut \\
\hline
{\em direction} & direction of cut relative to parent \\
\hline
{\em ofstreams\+\_\+idx} & index of std\+::ofstream (in ofstreams) for target CSV file \\
\hline
{\em ofstreams} & vector of std\+::ofstream objects for all currently opened CSV files \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
none 
\end{DoxyReturn}
\mbox{\Hypertarget{classCutflow_a212a44164cbf1f1608d1b55567890ef7}\label{classCutflow_a212a44164cbf1f1608d1b55567890ef7}} 
\index{Cutflow@{Cutflow}!recursiveWriteMermaid@{recursiveWriteMermaid}}
\index{recursiveWriteMermaid@{recursiveWriteMermaid}!Cutflow@{Cutflow}}
\doxysubsubsection{\texorpdfstring{recursiveWriteMermaid()}{recursiveWriteMermaid()}}
{\footnotesize\ttfamily void Cutflow\+::recursive\+Write\+Mermaid (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{classCut}{Cut}} $\ast$}]{cut,  }\item[{std\+::ofstream \&}]{ofstream,  }\item[{std\+::string}]{output\+\_\+mmd }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [protected]}}

(PROTECTED) Recursively write cutflow to a Mermaid (.mmd) file 
\begin{DoxyParams}{Parameters}
{\em cut} & pointer to current cut \\
\hline
{\em ofstream} & std\+::ofstream object for .mmd file \\
\hline
{\em output\+\_\+mmd} & name of .mmd file \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
none 
...
\end{DoxyReturn}
\mbox{\Hypertarget{classCutflow_a1657305fa62637aff34e1cece3d49d73}\label{classCutflow_a1657305fa62637aff34e1cece3d49d73}} 
\index{Cutflow@{Cutflow}!setDebugLambda@{setDebugLambda}}
\index{setDebugLambda@{setDebugLambda}!Cutflow@{Cutflow}}
\doxysubsubsection{\texorpdfstring{setDebugLambda()}{setDebugLambda()}}
{\footnotesize\ttfamily void Cutflow\+::set\+Debug\+Lambda (\begin{DoxyParamCaption}\item[{std\+::function$<$ void(\mbox{\hyperlink{classCut}{Cut}} $\ast$)$>$}]{new\+\_\+debugger }\end{DoxyParamCaption})}

Set debug function 
\begin{DoxyParams}{Parameters}
{\em new\+\_\+debugger} & lambda function that will be run before every cut \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
none 
...
none 
\end{DoxyReturn}
\mbox{\Hypertarget{classCutflow_a42bd2909f9e32bb12e7dbd717248a253}\label{classCutflow_a42bd2909f9e32bb12e7dbd717248a253}} 
\index{Cutflow@{Cutflow}!write@{write}}
\index{write@{write}!Cutflow@{Cutflow}}
\doxysubsubsection{\texorpdfstring{write()}{write()}}
{\footnotesize\ttfamily void Cutflow\+::write (\begin{DoxyParamCaption}\item[{std\+::string}]{output\+\_\+dir = {\ttfamily \char`\"{}\char`\"{}} }\end{DoxyParamCaption})}

Write RAPIDO cutflow file 
\begin{DoxyParams}{Parameters}
{\em output\+\_\+dir} & target directory for output cutflow files (optional) \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
none 
...
(PROTECTED) Map (\char`\"{}record\char`\"{}) of all cuts in cutflow \mbox{\Hypertarget{classCutflow_abb96db5e150faecc23c88456f27a2764}\label{classCutflow_abb96db5e150faecc23c88456f27a2764}} 
\index{Cutflow@{Cutflow}!debugger@{debugger}}
\index{debugger@{debugger}!Cutflow@{Cutflow}}
\doxysubsubsection{\texorpdfstring{debugger}{debugger}}
{\footnotesize\ttfamily std\+::function$<$void(\mbox{\hyperlink{classCut}{Cut}}$\ast$)$>$ Cutflow\+::debugger\hspace{0.3cm}{\ttfamily [protected]}}

(PROTECTED) Lambda function that runs before every cut for debugging purposes \mbox{\Hypertarget{classCutflow_ae8792b03dddaac635316012514ed33a3}\label{classCutflow_ae8792b03dddaac635316012514ed33a3}} 
\index{Cutflow@{Cutflow}!debugger\_is\_set@{debugger\_is\_set}}
\index{debugger\_is\_set@{debugger\_is\_set}!Cutflow@{Cutflow}}
\doxysubsubsection{\texorpdfstring{debugger\_is\_set}{debugger\_is\_set}}
{\footnotesize\ttfamily bool Cutflow\+::debugger\+\_\+is\+\_\+set\hspace{0.3cm}{\ttfamily [protected]}}

(PROTECTED) Flag indicating that a debugger lambda function has been set \mbox{\Hypertarget{classCutflow_a71390324488ac6ed4a72c41f4a2c1c10}\label{classCutflow_a71390324488ac6ed4a72c41f4a2c1c10}} 
