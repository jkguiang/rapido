\label{index_md__github_workspace_rapido_README}%
\Hypertarget{index_md__github_workspace_rapido_README}%
...
\DoxyCodeLine{    \{}
\DoxyCodeLine{        \mbox{\hyperlink{classCut}{Cut}}* terminal\_node = dummy\_cutflow.\mbox{\hyperlink{classCutflow_a8fc98b9c006b80db96576c8bdcf6a0a8}{run}}();}
...
\DoxyCodeLine{    \mbox{\hyperlink{classLooper}{Looper}} looper = \mbox{\hyperlink{classLooper}{Looper}}(tchain, \textcolor{stringliteral}{"{}TreeName"{}});}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{comment}{// Run}}
\DoxyCodeLine{    looper.\mbox{\hyperlink{classLooper_a8b259a7ad0c2aa45ae49d1ec08d37af0}{run}}(}
...
\DoxyCodeLine{                \{}
\DoxyCodeLine{                    arbol.\mbox{\hyperlink{classArbol_a811156c9134ca7e0015bbe2ab95434b0}{appendToVecLeaf}}<\textcolor{keywordtype}{float}>(\textcolor{stringliteral}{"{}good\_jet\_pt"{}}, selector.Jet\_pt[i]);}
...
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{comment}{// Initialize Looper}}
\DoxyCodeLine{    \mbox{\hyperlink{classLooper}{Looper}} looper = \mbox{\hyperlink{classLooper}{Looper}}(cli.\mbox{\hyperlink{classHEPCLI_a3d4bb4a7c1f1b6d4e008ff76e43bef15}{input\_tchain}}, cli.\mbox{\hyperlink{classHEPCLI_ad8364ec0fda19a180ccafbdb9866790f}{input\_ttree}});}
\DoxyCodeLine{}
\DoxyCodeLine{    \textcolor{comment}{// Initialize Arbol}}
\DoxyCodeLine{    output\_tfile = cli.\mbox{\hyperlink{classHEPCLI_a2c6e1c6b16b1980527bd660175e77bd8}{output\_dir}}+\textcolor{stringliteral}{"{}/"{}}+cli.\mbox{\hyperlink{classHEPCLI_a9e5f226adebb7d77fb601c93268868dd}{output\_name}}+\textcolor{stringliteral}{"{}.root"{}}}
\DoxyCodeLine{    \mbox{\hyperlink{classArbol}{Arbol}} arbol = \mbox{\hyperlink{classArbol}{Arbol}}(output\_tfile);}
...
\DoxyCodeLine{    \mbox{\hyperlink{classCutflow}{Cutflow}} cutflow = \mbox{\hyperlink{classCutflow}{Cutflow}}(cli.\mbox{\hyperlink{classHEPCLI_a9e5f226adebb7d77fb601c93268868dd}{output\_name}}+\textcolor{stringliteral}{"{}\_Cutflow"{}});}
\DoxyCodeLine{}
...
\DoxyCodeLine{    looper.\mbox{\hyperlink{classLooper_a8b259a7ad0c2aa45ae49d1ec08d37af0}{run}}(}
\DoxyCodeLine{        [\&](TTree* ttree)}
\DoxyCodeLine{        \{}
\DoxyCodeLine{            nt.Init(ttree);}
\DoxyCodeLine{        \},}
\DoxyCodeLine{        [\&](\textcolor{keywordtype}{int} entry) }
\DoxyCodeLine{        \{}
\DoxyCodeLine{            bar.progress(looper.\mbox{\hyperlink{classLooper_abbf626538aced372130172ac86958265}{n\_events\_processed}}, looper.\mbox{\hyperlink{classLooper_a6251eeff0d36df11886ac1a50521a1db}{n\_events\_to\_process}});}
\DoxyCodeLine{            nt.GetEntry(entry);}
\DoxyCodeLine{            \textcolor{comment}{// Reset tree}}
...
\DoxyCodeLine{    cutflow.writeCSV(cli.\mbox{\hyperlink{classHEPCLI_a2c6e1c6b16b1980527bd660175e77bd8}{output\_dir}});}
\DoxyCodeLine{    arbol.\mbox{\hyperlink{classArbol_ade7d835bbe383a70006e86785ae5672c}{writeTFile}}();}
\DoxyCodeLine{    \textcolor{keywordflow}{return} 0;}
\DoxyCodeLine{\}}
