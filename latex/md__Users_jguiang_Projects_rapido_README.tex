...
RAPIDO is a C++ framework designed to make writing HEP analyses more ergonomic and readable. It wraps some basic functionality of \href{https://root.cern/}{\texttt{ ROOT}}. The idea is that an analysis, in general, consists of a few objects\+: a TTree (to hold some skimmed N-\/\+Tuple and/or a set of histograms), a cutflow (a collection of boolean logic for filtering events), and a looper (some way to run over multiple files). RAPIDO is designed to handle all three of these tasks such that every analysis that uses it is structured in the same way. In addition, the {\itshape way} in which it is structured lends itself to the common workflow of a HEPEx-\/er.\hypertarget{md__Users_jguiang_Projects_rapido_README_autotoc_md1}{}\doxysection{RAPIDO Tools}\label{md__Users_jguiang_Projects_rapido_README_autotoc_md1}
...
\end{DoxyEnumerate}\hypertarget{md__Users_jguiang_Projects_rapido_README_autotoc_md2}{}\doxysection{Set Up Instructions}\label{md__Users_jguiang_Projects_rapido_README_autotoc_md2}
...
\end{DoxyEnumerate}\hypertarget{md__Users_jguiang_Projects_rapido_README_autotoc_md3}{}\doxysection{Examples}\label{md__Users_jguiang_Projects_rapido_README_autotoc_md3}
